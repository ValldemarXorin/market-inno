...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, UserStatusEvent> consumerFactory(KafkaProperties kafkaProperties) {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UserStatusEvent> kafkaListenerContainerFactory(
            ConsumerFactory<String, UserStatusEvent> consumerFactory,
            KafkaTemplate<String, Object> kafkaTemplate) {
        ConcurrentKafkaListenerContainerFactory<String, UserStatusEvent> factory =
